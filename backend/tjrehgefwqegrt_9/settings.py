"""
Django settings for tjrehgefwqegrt_9 project.
...
ROOT_URLCONF = 'tjrehgefwqegrt_9.urls'
...
WSGI_APPLICATION = 'tjrehgefwqegrt_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tjrehgefwqegrt_9 API",
    "DESCRIPTION": "API documentation for tjrehgefwqegrt_9 App",
    "VERSION": "v1",
}
